...
return [
    ...
    'events' => [
        ...
        'theme.site' => function ($theme) {
            ...
            $this->builder->addTransform('prerender', new DefaultTransform());
            $this->builder->addTransform('prerender', new PlaceholderTransform());
            $this->builder->addTransform('render', new ElementTransform($theme));
        },
        ...
        'builder.init' => function ($builder) {
            ...
            $builder->addTransform('precontent', new DefaultTransform());
        },
